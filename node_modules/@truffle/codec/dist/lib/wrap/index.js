...
exports.resolveAndWrap = exports.wrapForMethod = exports.wrapMultiple = exports.wrap = exports.BadResponseTypeError = exports.TypeMismatchError = exports.NoUniqueBestOverloadError = exports.NoOverloadsMatchedError = void 0;
...
function* wrapForMethodRaw(method, inputs, { userDefinedTypes, allowOptions }) {
    ...
    if (method.inputs.length === inputs.length) {
        ...
        const orOneMore = allowOptions
            ...
            : "";
        throw new errors_1.TypeMismatchError({ typeClass: "tuple", memberTypes: method.inputs }, inputs, "<arguments>", `Incorrect number of arguments (expected ${method.inputs.length}${orOneMore}, got ${inputs.length})`);
    }
}
function* resolveAndWrap(methods, inputs, { userDefinedTypes, allowOptions }) {
    ...
    //our overload resolution system
