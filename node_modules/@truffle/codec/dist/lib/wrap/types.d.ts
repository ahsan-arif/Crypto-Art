...
export declare type IntegerOrEnumType = Format.Types.UintType | Format.Types.IntType | Format.Types.EnumType;
export declare type DecimalType = Format.Types.FixedType | Format.Types.UfixedType;
export declare type NumericType = DecimalType | Format.Types.UintType | Format.Types.IntType;
export declare type IntegerOrEnumValue = Format.Values.UintValue | Format.Values.IntValue | Format.Values.EnumValue;
